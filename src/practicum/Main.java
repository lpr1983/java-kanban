...
//
//        Task task1 = new Task("Задача 1.", TaskStatus.NEW, "Описание задачи 1.");
...
//
//        Task task1updated = new Task(task1.getId(), task1.getName(), TaskStatus.DONE, task1.getDescription());
//        taskManager.updateTask(task1updated);
//
//        System.out.println("10. Задача 1 завершена: " + taskManager.getTasksList());
//
//        Epic epic2updated = new Epic(epic2.getId(), epic2.getName() + "!", epic2.getDescription());
